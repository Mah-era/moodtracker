# Mahera's Mood | Personal Analytics Prototype
...
- Tracks stress and energy on 1-5 scales.
- Tracks 5 daily Namaj entries: Fajr, Dhuhr, Asr, Maghrib, and Isha.
- Includes interactive monthly calendar, dashboard tabs, trend charts, scatter map, weekly outcomes, and correlation analysis.
- Provides JSON import/export for local data backup.
- Stores entries locally in browser localStorage.
